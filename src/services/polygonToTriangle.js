const polygonToTriangle = {
    ...
    triangulate: function (coords) {
        ...
        var n = points.length, m, angles = [], triangles = [], poly_cw, ear_cw, a, b, c, h, j, theta, min_ang, i, max_x;
...
export default polygonToTriangle;